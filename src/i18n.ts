...
const enTranslations = {
  ...
  lenses: {
    ...
    select: "Select",
    savedPrescriptionWillBeUsed: "Your saved prescription will be used",
    savedPrescriptionExplanation: "We'll use the prescription you have on file",
    useSavedPrescription: "Use saved prescription",
    useSavedPrescriptionDescription: "Use your previously saved prescription",
    enterPrescriptionDetails: "Enter your prescription details",
    selectVisionType: "Select Vision Type",
    customizeLenses: "Customize Your Lenses",
