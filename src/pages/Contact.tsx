      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="font-serif text-2xl font-bold mb-6">{t('contact.title')}</h2>
              <form>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label className="block text-gray-700 mb-1">{t('contact.firstName')}</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="block text-gray-700 mb-1">{t('contact.lastName')}</label>
                    <input 
                      type="text" 
                      className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
                      required
                ...
                <div className="mb-4">
                  <label className="block text-gray-700 mb-1">{t('contact.subject')}</label>
                  <input 
                    type="text" 
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
                    required
            ...
            {/* Contact Information */}
            <div>
              <h2 className="font-serif text-2xl font-bold mb-6">{t('contact.info')}</h2>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <MapPin className="w-5 h-5 text-blue-600 mr-3 mt-1 shrink-0" />
                  <div>
                    <h3 className="font-medium">{t('contact.store')}</h3>
